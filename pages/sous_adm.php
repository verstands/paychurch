<?php
    ...
    if (isset($_POST['creer'])) {
        ...
        eglise($login, $password, $email, $eglise);
...
<div class="layout-content">
    <div class="container">
        <h4 class="font-weight-bold py-3 mb-0"> <i class="fa fa-user-circle" style="font-size:25px;"></i> Creation d'un administrateur pour un company</h4>
        <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php?page=accueil"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item">Adm</li>
            </ol>
        </div>
        <a href="index.php?page=adm" class=" btn btn-primary">Les administrateur</a><br><br>
        <div class="card mb-4 ">
            <h6 class="card-header">administrateur</h6>
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="form-label">Nom de l'eglise</label>
                        <?php
                            $affiche = $con->query("SELECT * FROM eglise");
                        ?>
